/*
 * UUIDAutoGen.java		0.1		20/06/2006
 * 
	...
	public void run() {
		...
		if( traduc!=null && canRun() ) {
			...
			try {
				...
				JOptionPane.showMessageDialog( parentFrame, "Erreur d'éxécution.", "Erreur", JOptionPane.ERROR_MESSAGE );
			}

		} else {
			JOptionPane.showMessageDialog( parentFrame, "Impossible de charger le dictionnaire de données.", "Erreur", JOptionPane.ERROR_MESSAGE );
		}
	}
