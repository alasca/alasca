...
////////////////////////////////
	...
	**/
	public void removeAll() { onglets.removeAll(); }
...
////////////////////////////////
	...
	private void initFrame() {
		...
		//ongletsPanel.setBackground( new Color( 236, 232, 224 ) );
		...
		item_openFile.setAccelerator( KeyStroke.getKeyStroke(
				KeyEvent.VK_O, KeyEvent.CTRL_MASK ) );
		item_saveFile.setAccelerator( KeyStroke.getKeyStroke(
				KeyEvent.VK_S, KeyEvent.CTRL_MASK ) );
		item_closeFile.setAccelerator( KeyStroke.getKeyStroke(
