...
////////////////////////////////
	...
	public RFCSyntax() {
		super( RFC_ATTRIBUTE.substring( 0, RFC_ATTRIBUTE.length()-2 ),
				RFC_ATTRIBUTE,
...
////////////////////////////////
	...
	**/
	public SchemaFileReader createSchemaReader() { return new RFCReader( this ); }
	...
	**/
	public SchemaFileWriter createSchemaWriter() { return new RFCWriter(); }
