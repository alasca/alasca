...
public class Config
{
	...
	public static final String dataPathEnvName = "ALASCA_DATA_PATH";

	public static final String libraryPathEnvName = "ALASCA_LIB_PATH";

	public static final String pluginPathEnvName = "ALASCA_PLUGIN_PATH";

	public static final String resourcesPathEnvName = "ALASCA_RESOURCES_PATH";
